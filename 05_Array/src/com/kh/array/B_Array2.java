...
public class B_Array2 {
	 ...
	 * 			=> 기본 자료형 외의 자료형 (int[], double[], ..., String, Scanner, ...)으로 선언된 변수
	 * 
	 * * 배열 특징
	 * 	- 배열을 생성한 후 직접 값을 초기화 하지 않아도 기본값으로 초기화 됨!
	 * 	 => Heap 이라는 메모르 공간은 빈 공간으로 존재할 수 없어서
	...
	public static void main(String[] args) {
		...
		// --------------------------------------------
		int[] arr = null;	// 아무고토 참조하고 있지 않음!
		System.out.println(arr);
		
		arr = new int[5];
		System.out.println(arr[4]);
		// System.out.println(arr[5]);	// ArrayIndexOutOfBoundsException 에러
