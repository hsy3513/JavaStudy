...
public class API2_String {
	...
	public static void test1() {
		...
		// => String 클래스에서 toString() 재정의 되어 있음!
		// 저장된 값을 리턴하도록 재정의!

		// * 주소값(해시값)을 확인 하는 메소드: System.identityHashCode(변수)
	...
	public static void test2() {
		...
		//			   문자열A에 문자열B가 포함되어 있는 지 학인하여 리턴
		System.out.println(str1.contains("el"));
		System.out.println(str1.contains("ex"));
