...
public class Run {
	...
	public static void main(String[] args) {
		...
		// => 자식객체의 멤버에 접근하고자 한다면, 강제형변환 후 접근 가능!! -> "다운캐스팅"
		System.out.println("=============================");
			
		/*
		 * * 다형성: 부모 타입으로부터 파생된 자식 객체들을 부모타입 하나로 다룰 수 있는 기술!
		 * 
		 *   - 장점: 하나의 부모 타입만으로 여러 자식 객체들을 다룰 수 있어 "편리"하고 "코드길이가 감소"됨!
		 *   
		...
		Car[] cArr = new Car[6];
		cArr[0] = new Car();
		cArr[1] = new Lamborgh("Yellow", "고급유", 2021);
		cArr[2] = new Genesis("Silver", "가솔린", 2024);
