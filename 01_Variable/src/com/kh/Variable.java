...
public class Variable {
	...
	public static void printVariable() {
		...
		int timePay = 10030;
		timePay = timePay + 500;
		System.out.println("홍길동: " + (timePay * 8 * 5) + "원");
		System.out.println("아이유: " + (timePay * 6 * 5) + "원");
		System.out.println("진: " + (timePay * 15 * 28) + "원");
		System.out.println("유재석: " + (timePay * 20 * 31) + "원");
	...
	public static void declareVariable() {
		 ...
		 * - 변수명: 면수의 이름을 부여하는 부분(의미있게!)
		 * ***
		 * 명명 규칙
		 *  [1] 카멜 케이스: 소문자로 시작하고, 다른 단어가 붙을 경우 첫 글자를 대문자로 시작
		 *  	- 상수: 스네이크 케이스 (SNAKE_CASE) 모두 문자로 작성하고 다른 단어는 _로 구분
